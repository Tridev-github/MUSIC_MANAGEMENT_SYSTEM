...
<div class="container_wrapper">
    ...
    <div style="margin-left:330px;" class="home_content">
    	<h2 class="header">Album Record Section</h2>
        	<div class="form">
            	<table style="width:" border="0" cellpadding="1" cellspacing="0" bgcolor="">
                    ...
                    <tr style="background-color:#fff;" align="center" bgcolor="<?php echo $bgcolor?>">
                        ...
                        <td align="center" >
							<a class="btn yellow black-text" href="AdminViewSongs.php?id=<?php echo $rowCat['id'];?>" class="link">View Songs</a>&nbsp;|&nbsp;
							<a class="btn" href="AdminSong.php?id=<?php echo $rowCat['id'];?>" class="link">Add Song</a>&nbsp;|&nbsp;
							<a class="btn grey" href="AdminEditAlbum.php?id=<?php echo $rowCat['id'];?>" class="link">Edit</a>&nbsp;|&nbsp;
							<a class="btn red" href="AdminDeleteAlbum.php?id=<?php echo $rowCat['id'];?>" class="link" onclick="return confirm('Do you want to delete this?');">Delete</a>
						</td>
                    ...
                    <?php
						...
						if($numpage>$limit){
							...
							if($back>=0){
								echo "<a class= 'btn yellow black-text' href=$page?start=$back>PREV</a>";
							}
							echo "</td><td align=center>";
								$l = 1;
								for($i = 0; $i < $numpage;$i = $i + $limit){
									if($i<>$eu){
										echo "<a class= 'btn yellow black-text' href=$page?start=$i><font color=red>$l</font></a>";
									}else{
										echo "<font class= 'btn yellow black-text' color=red>$l</font>";
									}
									$l = $l + 1;
								}
							echo "</td><td align=right>";
							if($thisp<$numpage){
								echo "<a class= 'btn yellow black-text' href=$page?start=$next>NEXT</a>";
							}
							echo "</td></tr></table>";
						}
					?>
