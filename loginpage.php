...
<title>MUSIQUE Music | Login</title>
<!-- BOOTSTRAP -->
...
<body>
	<nav style="background-color: #232931;" class="navbar navbar-expand-lg navbar-light menu">
	  <a style="color: #f4f3f3;" class="navbar-brand " href="#" >MUSIQUE</a>
...
<div class="wrapper fadeInDown">
  <div style="    top: 75px;" id="formContent">
    <!-- Tabs Titles -->
 <div style="margin-top:30px;" >
<h3 style="font-weight:100;">ADMIN LOGIN</h3>
 </div>
    <!-- Login Form -->
    <form action="login.php" method="post" id="form">
      <input type="text" id="login" class="fadeIn second" name="username" placeholder="username">
      <input type="text" id="password" class="fadeIn third" name="password" placeholder="password">
			<input style="margin-top:10px; margin-bottom: 10px;" type="submit" class="fadeIn fourth" value="Login"/>&nbsp;<input type="reset" value="Cancel"/>
    </form>
		<?php
